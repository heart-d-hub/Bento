...
export const MOCK_PRODUCTS: InventoryProduct[] = [
  ...
  /** ทดสอบหน้า «สินค้าใกล้หมด» — สต็อกต่ำกว่า min (SKU TST-LS-* ไม่ซ้ำมาสเตอร์) */
  {
    id: 'p-lowtest-01',
    sku: 'TST-LS-01',
    genuineNo: '—',
    factoryOem: 'TST-LS-01',
    name: '[ทดสอบ] กรองอากาศเดโม A',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 1,
    minStock: 12,
    category: 'ทดสอบใกล้หมด',
  },
  {
    id: 'p-lowtest-02',
    sku: 'TST-LS-02',
    genuineNo: '—',
    factoryOem: 'TST-LS-02',
    name: '[ทดสอบ] ผ้าเบรกหน้าเดโม',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 0,
    minStock: 8,
  ...
  },
  {
    ...
    sku: 'TST-LS-03',
    genuineNo: '—',
    factoryOem: 'TST-LS-03',
    name: '[ทดสอบ] น้ำมันเครื่อง 5W-30 (ถัง)',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 2,
    minStock: 15,
  ...
  },
  {
    ...
    sku: 'TST-LS-04',
    genuineNo: '—',
    factoryOem: 'TST-LS-04',
    name: '[ทดสอบ] ปั๊มน้ำเดโม',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 0,
    minStock: 4,
  ...
  },
  {
    ...
    sku: 'TST-LS-05',
    genuineNo: '—',
    factoryOem: 'TST-LS-05',
    name: '[ทดสอบ] สายพานหน้าเครื่อง',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 1,
    minStock: 6,
  ...
  },
  {
    ...
    sku: 'TST-LS-06',
    genuineNo: '—',
    factoryOem: 'TST-LS-06',
    name: '[ทดสอบ] หัวเทียน (ชุด 4)',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 3,
    minStock: 20,
  ...
  },
  {
    ...
    sku: 'TST-LS-07',
    genuineNo: '—',
    factoryOem: 'TST-LS-07',
    name: '[ทดสอบ] ยางปัดน้ำฝน 26"',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 0,
    minStock: 10,
  ...
  },
  {
    ...
    sku: 'TST-LS-08',
    genuineNo: '—',
    factoryOem: 'TST-LS-08',
    name: '[ทดสอบ] แบต 12V 45Ah',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 1,
    minStock: 5,
  ...
  },
  {
    ...
    sku: 'TST-LS-09',
    genuineNo: '—',
    factoryOem: 'TST-LS-09',
    name: '[ทดสอบ] ไส้กรองโซล่า',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 2,
    minStock: 18,
  ...
  },
  {
    ...
    sku: 'TST-LS-10',
    genuineNo: '—',
    factoryOem: 'TST-LS-10',
    name: '[ทดสอบ] ลูกรอกสายพาน',
    brand: 'Demo',
    location: 'TST-LS',
    stock: 0,
    minStock: 7,
